                                    ...
                                    <hr>
                                            <table class="table table-borderless">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>:</td>
                                                    <td>{{$gelombang->tgl_pemetaan_jurusan}}, {{$peserta->jadwal->jam}} WIB</td>
                                                </tr>
                                                <tr>
                                                    <td>Nama Ruangan</td>
                                                    <td>:</td>
                                                    <td>{{$peserta->jadwal->ruangan}}</td>
                                                </tr>
                                            </table>
                                            {{-- <p class="text-start">Tasikmalaya, {{Carbon::today()->format('d/m/Y')}}<br><br><br><br><br> Panitia PPDB SMK YPC</p> --}}
